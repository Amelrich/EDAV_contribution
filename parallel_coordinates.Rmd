...
En général, on utilise le clustering quand on veut observer un motif récurrent dans une série de cas avec des propriétés spécifiques. Ceci peut diviser les variables en clusters selon leur valeur spécifique pour une valeur de variable catégorique particulière. But you can even use a continuous variable; for example, dividing all cases into two sections based on some continuous variable *height*: those who have a height greater than 150cm and those who do not. 
